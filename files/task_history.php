    ...
    <section class="content">
		...
		<div class="col-md-12">
            ...
            <div class="box-header">
              ...
              <h3 class="box-title">To Do List History</h3>
            ...
            <div class="box-body">
			  ...
			  $c=0;
							$sql1 = "SELECT *  FROM TO_DO_LIST WHERE SIGN_UP_ID='$SIGN_UP_ID' AND TO_DO_LIST_STATUS=0";
                ...
                <li>
				 ...
				 <small class="label label-warning"><i class="fa fa-clock-o"></i> <?php echo $TO_DO_LIST_WHEN;?></small>
                  <!-- General tools such as edit or delete-->
                  <div class="tools">
                   <a href="task_edit.php?TO_DO_LIST_ID=<?php echo $TO_DO_LIST_ID; ?>"> <i class="fa fa-edit"></i></a>              
				   <a href="task_delete.php?TO_DO_LIST_ID=<?php echo $TO_DO_LIST_ID; ?>">
