...
session_start();
  ...
  $DEBT_SETTLEMENT_ID=$_GET['DEBT_SETTLEMENT_ID'];
   ...
   require_once('dbconnect.php');
								...
								$sql = "SELECT *  FROM   DEBT_SETTLEMENT WHERE DEBT_SETTLEMENT_ID='$DEBT_SETTLEMENT_ID'";
        ...
        <div class="col-md-8">
		 ...
		 <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">DEBT SETTLEMENT DETAILS</h3>
            </div>
            <div class="box-body">
			
		 <form action="edit_operation.php?DEBT_SETTLEMENT_ID=<?php echo $DEBT_SETTLEMENT_ID;?>" method="POST">	
               <div class="form-group has-feedback">
	  <label>Debtor or Creditor Name</label>
        <input type="text" class="form-control" name="name" value="<?php echo $DEBT_SETTLEMENT_WITH;?>" required>
      </div>
              <br>
			  
			  
               <div class="form-group has-feedback">
	  <label>Debtor or Creditor Contact</label>
        <input type="text" class="form-control" name="contact" value="<?php echo $DEBT_SETTLEMENT_CONTACT;?>">
      </div>
              <br>
			  
 <div class="form-group has-feedback">
	  <label>Amount</label>
        <input type="text" class="form-control" name="amount" value="<?php echo $DEBT_SETTLEMENT_AMOUNT;?>" required>
      </div>
              
              <br>

				<div class="form-group">
				<label>Debt Selection</label>
				<select class="form-control"  name="debt_selection" >
				
				<?php 
				  if($DEBT_SETTLEMENT_TYPE=="Debtor")
				  {
				   ?>
					<option selected>Debtor</option>
				...
				else if($DEBT_SETTLEMENT_TYPE=="Creditor")
				  {
				   ?>
					<option>Debtor</option>
					<option selected>Creditor</option>
			 ...
			 <div class="form-group">
                <label>Last Of Date Payment</label>

                      <div class="form-group has-feedback">
        <input type="date" class="form-control" name="date"; value="<?php echo $DEBT_SETTLEMENT_PAYMENT_DATE;?>" required>
        <!--span class="glyphicon glyphicon-user form-control-feedback"></span-->
			  ...
			  <div class="form-group">
                  <label>Details</label>
                  <textarea class="form-control" rows="3" name="details"> <?php echo $DEBT_SETTLEMENT_CUZ;?></textarea>
                </div>
