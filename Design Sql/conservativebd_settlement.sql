...
--
-- Host: localhost:3306
-- Generation Time: Jan 02, 2021 at 08:00 PM
...
--
-- Database: `conservativebd_settlement`
--
...
CREATE TABLE `DEBT_SETTLEMENT` (
  ...
  `DEBT_SETTLEMENT_WITH` text DEFAULT NULL,
  `DEBT_SETTLEMENT_AMOUNT` text DEFAULT NULL,
  `DEBT_SETTLEMENT_TYPE` text DEFAULT NULL,
...
(26, 11, 'Tofael Ahmed Rafi', '300', 'Debtor', '2017-12-30', 1, '01798710944', '  Owed for treat & fine of HSC test exam', '2021-02-14'),
...
(29, 11, 'Tanvir Hassan', '300', 'Debtor', '2021-01-02', 0, '01636841632', '   Borrowed to buy T-Shirt', '2021-01-04'),
(30, 11, 'KupiBati', '500', 'Creditor', '2021-01-02', 1, '01781634034', 'Borrowed to through Party', '2021-02-14'),
(31, 11, 'Numan', '750', 'Debtor', '2021-01-02', 0, '01705736473', 'For train ticket booking', '2021-01-07'),
(32, 11, 'Ankin', '140', 'Creditor', '2021-01-02', 1, '01990308012', 'Brought AKG Earphone', '2021-01-01'),
(33, 11, 'Ankin', '140', 'Creditor', '2021-01-02', 0, '01990308012', 'Brought an AKG Earphone', '2021-01-08'),
(34, 11, 'Ankin', '350', 'Creditor', '2021-01-02', 1, '01990308012', 'Brought a Feature phone with memory card & a battery', '2021-03-12'),
(35, 11, 'KupiBati', '110', 'Creditor', '2021-01-02', 1, '01781634034', 'Just Borrowed', '2021-02-14'),
(36, 11, 'Rokey', '2000', 'Creditor', '2021-01-02', 1, '0161967996', 'To Invest in KupiBati', '2021-04-14');
...
CREATE TABLE `SIGN_UP` (
  `SIGN_UP_ID` int(11) NOT NULL,
  `SIGN_UP_NAME` text DEFAULT NULL,
  `SIGN_UP_DATE` date DEFAULT NULL,
  `SIGN_UP_PHONE` text DEFAULT NULL,
  `SIGN_UP_MAIL` varchar(256) DEFAULT NULL,
  `SIGN_UP_PASSWORD` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `TO_DO_LIST` (
  ...
  `SIGN_UP_ID` int(11) NOT NULL,
  `TO_DO_LIST_DETAIL` text DEFAULT NULL,
  `TO_DO_LIST_DURATION` text DEFAULT NULL,
...
(12, 11, 'CSE 302 Lab Project Final', '6 hours', '2021-01-02', 1, '2021-01-03'),
(13, 11, 'Help in a Project of Naimur Rahman Shanto', '6 hours', '2021-01-02', 0, '2021-01-02');
...
--
ALTER TABLE `DEBT_SETTLEMENT`
  MODIFY `DEBT_SETTLEMENT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `TO_DO_LIST`
  MODIFY `TO_DO_LIST_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
